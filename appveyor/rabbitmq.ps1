...
$exePath = "$($env:USERPROFILE)\rabbitmq-server-3.7.13.exe"
(New-Object Net.WebClient).DownloadFile('https://dl.bintray.com/rabbitmq/all/rabbitmq-server/3.7.13/rabbitmq-server-3.7.13.exe', $exePath)

Write-Host "Installing..."
cmd /c start /wait $exePath /S

$rabbitPath = 'C:\Program Files\RabbitMQ Server\rabbitmq_server-3.7.13'
